...
public class ContsPlusbtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conts_plusbt);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ContsPlusbtActivity.this));
        ...
        adapter = new ContsDataPlusbtAdapter(ContsPlusbtActivity.this,datalist);
        ...
        adapter.setListener(new ContsDataPlusbtAdapter.Listener() {
            ...
            public void getUser(String userid) {
                ...
                Intent intent = new Intent(ContsPlusbtActivity.this, UserActivity.class);
    ...
    public void getShop() {
        ...
        Call<List<ContsData>> call = dataApi.getPlus(page_n,idsids);
