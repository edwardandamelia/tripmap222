...
public class ModfyActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modfy2);
        ...
        regbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userid!=""&&img_str!=""&&gender_str!=""){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ModfyActivity2.this);
    ...
    private void insertUser() {
        ...
        Call<List<MemberData>> call = contsDataApi.insertUser2(ChkData.logid,gender_str, ChkData.sitecte,img_str);
