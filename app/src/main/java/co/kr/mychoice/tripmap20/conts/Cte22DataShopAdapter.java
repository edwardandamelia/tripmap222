...
public class Cte22DataShopAdapter extends RecyclerView.Adapter<Cte22DataShopAdapter.ContsHolder>{
    ...
    @NonNull
    @Override
    public Cte22DataShopAdapter.ContsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.conts2_conts,
                parent,false);

        return new Cte22DataShopAdapter.ContsHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Cte22DataShopAdapter.ContsHolder holder, int position) {
    ...
    public Cte22DataShopAdapter(Context context, ArrayList<ContsData> contsdatas) {
