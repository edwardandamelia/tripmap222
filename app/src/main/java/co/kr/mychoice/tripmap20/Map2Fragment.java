...
public class Map2Fragment extends Fragment implements OnMapReadyCallback, View.OnTouchListener,GoogleMap.OnCameraMoveStartedListener,GoogleMap.OnCameraIdleListener,GoogleMap.OnCameraMoveListener {
    ...
    public void getShop(final double distance) {
        ...
        Call<List<CteData>> call = dataApi.get2Cte(distance,lat20,lng20,"2");
