...
public class Cte2RegActivity extends AppCompatActivity {
    ...
    LinearLayout select_locationbt;

    LinearLayout select_locationbt2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cte2_reg);
        ...
        select_locationbt = findViewById(R.id.select_locationbt);
        select_locationbt2 = findViewById(R.id.select_locationbt2);

        place_str = findViewById(R.id.place_str);

        place_str2 = findViewById(R.id.place_str2);
        ...
        imgbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (img_chk > 5) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Cte2RegActivity.this);
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(Cte2RegActivity.this);
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (str[0].equals("Choose Image")) {
                                ...
                                if (cameraIntent.resolveActivity(getPackageManager()) != null) {
                                    ...
                                    if (photoFile != null) {
                                        Uri photoURI = FileProvider.getUriForFile(Cte2RegActivity.this,
        ...
        select_locationbt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                locationStr();
            }
        ...
        select_locationbt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(place.equals("")){

                    AlertDialog.Builder builder = new AlertDialog.Builder(Cte2RegActivity.this);
                    builder.setMessage("Select destination country first.");
                    builder.setCancelable(true);
        ...
        regbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (str_conts.equals("") || str2_conts.equals("") || place.equals("")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Cte2RegActivity.this);
    ...
    private void uploadImageUsingRetrofit() {
        ...
        progress =  ProgressDialog.show(Cte2RegActivity.this,null,null);
        ...
        Call<ContsData> call = contsDataApi.insertTrReg2(contsdata);
                    ...
                    builder.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    Intent intent = new Intent(Cte2RegActivity.this, MainActivity.class);
        ...
        alertBuilder.setAdapter(arrayAdapter,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog,
                        ...
                        place_str.setText(str);

                        place =str;

                        place_str2.setText("Select");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMG && resultCode == RESULT_OK) {
            ...
            //Toast.makeText(Cte2RegActivity.this, "",Toast.LENGTH_LONG).show();
        }
    }
    ...
    public String getRealPathFromDocumentUri(Uri uri){
        ...
        Cursor cursor = Cte2RegActivity.this.getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
