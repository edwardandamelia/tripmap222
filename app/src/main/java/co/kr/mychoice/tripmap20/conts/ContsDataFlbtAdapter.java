...
public class ContsDataFlbtAdapter extends RecyclerView.Adapter<ContsDataFlbtAdapter.ContsHolder>{
    ...
    @NonNull
    @Override
    public ContsDataFlbtAdapter.ContsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.conts2_conts,
                parent,false);

        return new ContsDataFlbtAdapter.ContsHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ContsDataFlbtAdapter.ContsHolder holder, int position) {
    ...
    public ContsDataFlbtAdapter(Context context, ArrayList<ContsData> contsdatas) {
