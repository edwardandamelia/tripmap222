...
public class ContsFlbtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conts_flbt);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ContsFlbtActivity.this));
        ...
        adapter = new ContsDataFlbtAdapter(ContsFlbtActivity.this,datalist);
        ...
        adapter.setListener(new ContsDataFlbtAdapter.Listener() {
            ...
            public void getUser(String userid) {
                ...
                Intent intent = new Intent(ContsFlbtActivity.this, UserActivity.class);
    ...
    public void getShop() {
        ...
        Call<List<ContsData>> call = dataApi.getFl(page_n, userid);
